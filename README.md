...
Python Flask PostgreSQL Railway PayMongo Figma
...
🔗 Chukakoy Car Rental System (Railway)

👨‍💻 Developers

Eduardo D. Masangcay (Me)
Web Developer
...
Railway — deployment and cloud hosting
PayMongo — online payment gateway integration
Figma — ERD and design planning
Shields.io — technology badges used in this README
📜 License
This project is developed for academic purposes at St. Cecilia's College-Cebu, Inc.

© 2026 Eduardo D. Masangcay — BSIT 2-E

If you want, I’ll send a shorter version without any code fences so absolutely zero paste issues.
